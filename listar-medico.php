	...
	if($qtd > 0){
		...
		while($row = $res->fetch_object()){
			...
			print "<td>
						...
						<button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir')){location.href='?page=salvar-paciente&acao=excluir&id_paciente=".$row->id_medico."';}else{false;}\">Excluir</button>
			       </td>";
			print "</tr>";
		}
		print "</table>";
